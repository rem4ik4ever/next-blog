...
module.exports = __webpack_require__("eQOz");
...
const uploadFile = async (req, res) => {
  try {
    ...
    src_utilities__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].Files.writeJSONToFile("./data/assets", file);
    res.statusCode = 200;
...
const listFiles = async (_, res) => {
  try {
    const files = src_utilities__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].Files.allFiles();
    res.statusCode = 200;
